...
image: /images/laptop-coding.jpg
---
...
You've probably heard of the [Dunning-Kruger effect](https://en.wikipedia.org/wiki/Dunning%E2%80%93Kruger_effect) before. I find the concept is becoming increasingly more visible in today's world generally, and in software engineering it's no exception. Far too often, when people are faced with a new challenge they're unfamiliar with, they look in their toolbox and just choose whatever's most familiar to them. And while in most cases, it works out fine to follow those instincts, it's not always the case.


## Build teams and people, not just code

In my eyes, the real value of a good lead or senior developer isn't the amount of code they can write or their domain specific expertise. Rather, it's that they can help less experienced devs "level up" in ability much faster than they would otherwise. Even in environments that emphasize splitting up work to be done in a solo manner, there's often large amounts of teamwork and interactivity (e.g. code reviews, sprint planning, etc), which in my opinion is a huge opportunity to learn. 

For example, take code reviews as an opportunity to mention not just _what_ needs changing, but also _why_. Whether i

That's not to say that they should _only_ be mentoring juniors all the time. After all, they're still developers, and not coding bootcamp teachers.
