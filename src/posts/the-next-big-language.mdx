...
Annotations, or decorators are a common way of doing metaprogramming - TODO DEFINITION. Controversially, I _like_ annotations and decorators (or macros in the Rust world). In my regular day to day work, I make use of them heavily with TypeScript packages like NestJS and class-validator. That said, I absolutely do understand their criticisms:
...
Unfortunately, I simply think the days of the next big hit programming language being developed by a small group of people in a basement is now over - there are so many well-established existing choices out there and the ecosystems and resources of each choice is _huge_.

Not to despair though - Go, Rust and TypeScript have also been open source since day 1 of their inception, and have had really great community-driven development and direction, and corporate sponsorship of open source is becoming more commonplace and widely accepted.
...
- Sane module system and package manager.
- Highly configurable linter (with sane defaults).
